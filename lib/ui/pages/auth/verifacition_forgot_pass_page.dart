...
class VerifacitionForgotPassPage extends StatelessWidget {
  const VerifacitionForgotPassPage({super.key});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                OtpTextField(
                  numberOfFields: 5,
                  focusedBorderColor: const Color(0xff00A784),
                  fieldWidth: 60.w,
                  enabledBorderColor: const Color(0xffff6767),
